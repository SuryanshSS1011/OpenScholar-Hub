...
const SignIn = () => {
  ...
  // No need for the useEffect redirect since we're using withPublicAuth
  ...
  return (
    <>
      <Head>
        <title>Sign In - OpenScholar Hub</title>
        <meta name="description" content="Sign in to OpenScholar Hub to collaborate on research projects" />
      </Head>
              ...
              <div className="mt-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center space-x-4">
                    <button
                      disabled
                      className="py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-400 opacity-50 cursor-not-allowed"
                    >
                      Email/Password
                    </button>
                    <button
...
export default withPublicAuth(SignIn);