// @/components/organisms/ResearchRecommendations.tsx
          ...
          {recommendations.map((paper) => (
            <div key={paper.id} className="border-b border-gray-100 pb-3 last:border-b-0 last:pb-0">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${getRelevanceColor(paper.relevance)}`}>
