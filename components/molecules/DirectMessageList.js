// @/components/molecules/DirectMessageList.js
 ...
 */
const DirectMessageList = ({ activeDmId }) => {
  ...
  useEffect(() => {
    const fetchDirectMessages = async () => {
      try {
        ...
        // Mock data
        const mockDms = [
          { id: 'D0123', name: 'Jane Smith', status: 'active', avatar: null, unreadCount: 2 },
          { id: 'D0124', name: 'Robert Johnson', status: 'away', avatar: null, unreadCount: 0 },
          { id: 'D0125', name: 'Emma Williams', status: 'active', avatar: null, unreadCount: 0 },
        ];
