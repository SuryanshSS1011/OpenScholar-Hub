...
const ProjectDetail: NextPage = () => {
  ...
  useEffect(() => {
    const fetchProjectData = async () => {
      ...
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : 'Failed to load project. Please try again.';
  ...
  const handleDeleteProject = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to delete project. Please try again.';
      setError(errorMessage);
      setIsDeleting(false);
