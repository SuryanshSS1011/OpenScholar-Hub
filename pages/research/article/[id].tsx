...
const ArticlePage: NextPage = () => {
  ...
  const id = Array.isArray(router.query.id) 
    ? router.query.id[0] 
    : router.query.id;
  const [articleTitle, setArticleTitle] = useState<string>('Article Details');
  ...
  const handleViewSource = () => {
    if (articleData) {
      window.open(`https://doi.org/${articleData.doi}`, '_blank');
    }
  };

  const handleCite = () => {
    if (articleData) {
      window.open(`https://www.doi.org/${articleData.doi}`, '_blank');
    }
  };
              ...
              <div className="lg:col-span-3 space-y-6">
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                  ...
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="mt-6">
                      <Link
                        href={id ? `/research?related=${encodeURIComponent(id)}` : '/research'}
